    ...
    <Popover className="relative">
      <Popover.Button className="py-[3.3px] outline-none">
        <div className="p-3 rounded-full transition-colors inline-flex items-center gap-5 group-hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl text-[#e7e9ea]">Daha fazla</div>
        </div>
      </Popover.Button>

      <Popover.Panel className="absolute z-10 w-[318px] bottom-0 left-0 bg-black rounded-xl shadow-box overflow-hidden">
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-6 hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl font-bold text-[#e7e9ea]">
            Para kazanma
          </div>
        </button>
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-6 hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl font-bold text-[#e7e9ea]">Pro</div>
        </button>
        ...
        <button className="px-4 h-14 w-full transition-colors inline-flex items-center gap-6 hover:bg-[#eff3f41a] ">
          ...
          <div className="pr-4 text-xl font-bold text-[#e7e9ea]">Reklamlar</div>
        </button>
